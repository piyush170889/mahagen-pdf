                                    ...
                                    <div class="carousel-inner">
                                        <%
                                            try {
                                                ...
                                                PreparedStatement ps2 = cn.prepareStatement("select * from user where empcode=?");
                                        ...
                                        <table style="color:white" border="0" cellspacing="10" cellpadding="10">
                                            <%while (rs2.next()) {
                                            %>
                                            <tbody>
                                                <tr>
                                                    <th>Employee Code</th>
                                                    <td><%out.println(rs2.getString("empcode"));%></td>
                                                </tr>
                                                <tr>
                                                    <th>Name:</th>
                                                    <td><%out.println(rs2.getString("name"));%></td>
                                                    <th>CPF Number</th>
                                                    <td><%out.println(rs2.getString("cpfno"));%></td>
                                                </tr>
                                                <tr>
                                                    <th>Email id</th>
                                                    <td><%out.println(rs2.getString("email"));%></td>
                                                    <th>Mobile Number</th>
                                                    <td><%out.println(rs2.getString("mob"));%></td>
                                                </tr>
                                                <tr>
                                                    <th>Date of Birth</th>
                                                    <td><%out.println(rs2.getString("dob"));%></td>
                                                    <th>Gender</th>
                                                    <td><%out.println(rs2.getString("gender"));%></td>           
                                                <tr>
                                                    <th>Date of Joining</th>
                                                    <td><%out.println(rs2.getString("jdate"));%></td>
                                                    <th>Date of End</th>
                                                    <td><%out.println(rs2.getString("edate"));%></td>
                                                </tr>    
                                                <%
                                                    }
                                                %>
                                        ...
                                        <table class="browse_tbl" border="0" cellspacing="10" cellpadding="10">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                    <td><a href="DeleteFile?fileToDelete=<%=rs1.getString("savedFileName")%>">Delete File</a></td>
                                                </tr>
                                                <%
                                                    }
                                                %>
