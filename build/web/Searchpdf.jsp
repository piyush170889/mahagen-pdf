                            ...
                            <div class="col-lg-8">
                                ...
                                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                    ...
                                    <div class="carousel-inner">
                                        <form action="Searchpdf1.jsp" method="post">             
                                            <table border="0" cellspacing="10" cellpadding="10">

                                                <tbody>
                                                    <tr>
                                                        <td style="color:white"> Search PDF By File Name:  </td>
                                                        <td><input required="required" type="text" value="" name="q" size="30" /></td>
<!--                                                    </tr>
                                                    <tr>-->
                                                        <td><input type="submit" name="Search" value="Search" class="btn-success" /></td>
                                                        <td></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                         ...
                                         <form action="Searchpdf2.jsp" method="post">             
                                            <table border="0" cellspacing="10" cellpadding="10">

                                                <tbody>
                                                    <tr>
                                                        <td style="color:white"> Search PDF By EMPCODE:  </td>
                                                        <td><input type="text" value="" name="q1" size="30" /></td>
<!--                                                    </tr>
                                                    <tr>-->
                                                        <td><input type="submit" name="Search" value="Search" class="btn-success" /></td>
                                                        <td></td>
                                        ...
                                        <form action="Searchpdf3.jsp" method="post">             
                                            <table border="0" cellspacing="10" cellpadding="10">

                                                <tbody>
                                                    <tr>
                                                        <td style="color:white"> Search PDF By CPF No. </td>
                                                        <td><input type="text" value="" name="q2" size="30" /></td>
<!--                                                    </tr>
                                                    <tr>-->
                                                        <td><input type="submit" name="Search" value="Search" class="btn-success" /></td>
                                                        <td></td>
