                            ...
                            <div>
                                ...
                                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                    ...
                                    <div class="carousel-inner">
                                        <section class="contact py-lg-0 py-md-3 py-sm-3 py-3" id="home_section">
                                            <div style="color:#FFF" class="container py-lg-0 py-md-4 py-sm-4 py-3" id="home_section">
                                                <div class="title text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">
                                                    <h1 align="center"><strong>Select PDF To Upload</strong></h1>
                                                </div>
