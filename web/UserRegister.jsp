                                    ...
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <section class="contact py-lg-4 py-md-3 py-sm-3 py-3" id="home_section">
                                                <div class="container py-lg-5 py-md-4 py-sm-4 py-3" id="home_section">
                                                    ...
                                                    <div class="agile-info-para">
                                                        ...
                                                        <form action="UserRegister" method="post">
                                                            <div class="row agile-wls-contact-mid">
                                                                ...
                                                                <div class="col-md-9 form-group contact-forms">
                                                                ...
                                                                <div class="col-md-9 form-group contact-forms">
                                                                    <input type="text" name="name" class="form-control" placeholder="Name" title="Username must not be blank and contain only letters and underscores at least 6 characters." >
                                                                </div>
                                                                <div class="col-md-3 form-group contact-forms">
                                                                ...
                                                                <div class="col-md-9 form-group contact-forms">
                                                                    <input type="email" name="email" class="form-control" placeholder="Email" required pattern="[a-z]+.[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$">
                                                                </div>
                                                                <div class="col-md-3 form-group contact-forms">
                                                                ...
                                                                <div class="col-md-9 form-group contact-forms">
                                                                    <input data-date-format="dd/mm/yyyy" type="date" name="dob" class="form-control datepicker" placeholder="Date Of Birth"  >
                                                                </div>
                                                                <div class="col-md-3 form-group contact-forms">
                                                                    <label style="color:white;">Mobile Number</label>
                                                                </div>
                                                                <div class="col-md-9 form-group contact-forms">
                                                                    <input type="text" name="mob" class="form-control" placeholder="Mobile Number" >
                                                                </div>
                                                                <div class="col-md-3 form-group contact-forms">
                                                                ...
                                                                <div class="col-md-9 form-group contact-forms">
                                                                    <input data-date-format="dd/mm/yyyy" type="date" name="jdate" class="form-control datepicker" placeholder="Joining Date"  >
                                                                </div>
                                                                <div class="col-md-3 form-group contact-forms">
                                                                    <label style="color:white;">Ending Date</label>
                                                                </div>
                                                                <div class="col-md-9 form-group contact-forms">
                                                                    <input data-date-format="dd/mm/yyyy" type="date" name="edate" class="form-control datepicker" placeholder="Ending Date"  >
                                                                </div>
                                                                <div class="col-md-3 form-group contact-forms">
                                                                    <label style="color:white;">CPF No.</label>
                                                                </div>
                                                                <div class="col-md-9 form-group contact-forms">
                                                                    <input type="text" name="cpfno" class="form-control" placeholder="CPF No."  >
                                                                </div>
                                                                <div class="col-md-12 form-group contact-forms">
                                                                    <center><br><input type="submit" value="Submit" class=" btn btn-success"/></center>
                                                                </div>
                                                            </div>
                                                        </form>
